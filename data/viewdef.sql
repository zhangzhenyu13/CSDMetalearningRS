...
select handle, floor(datediff(now(),memberSince)/30),skills,competitionNums,submissionNums,winNums from user;
...
create view submission(taskid,handle,subnum,score) as 
